...
//	initIDs();
    ...
    private static long dosToJavaTime(long dtime) {
        ...
        calendar.set( (int) ( ( (dtime >> 25) & 0x7f) + 80),
                     (int) ( ( (dtime >> 21) & 0x0f) - 1),
                     (int) ( (dtime >> 16) & 0x1f),
                     (int) ( (dtime >> 11) & 0x1f),
                     (int) ( (dtime >> 5) & 0x3f),
         ...
         * old
             ...
             return d.getTime();
         */
        return Long.parseLong(calendar.getTime().toString());
    }
	...
	private static long javaToDosTime(long time) {
        ...
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(d);
        int year = calendar.get(calendar.YEAR); //d.getYear() + 1900;
        if (year < 1980) {
            return (1 << 21) | (1 << 16);
        }
        return (year - 1980) << 25 | (calendar.get(calendar.MONTH) + 1) << 21 |
